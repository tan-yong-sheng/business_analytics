...
4. Data Analysis (Insight Generation)
   ...
   - Use Python for A/B testing to find the most effective promotion strategies to maximize sales outcomes. For example, in this project, we found that Promotion 1 and Promotion 3 outperform Promotion 2 after carrying out the [t-test](https://github.com/tan-yong-sheng/business_analytics/blob/main/iv%20Data%20Analysis%20(Insight%20Generation)/Final%20Project/Assignment%205/EDA_Final_Project.pdf).
